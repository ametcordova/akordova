...
$bloque1 = <<<EOF
	...
	<table>
		...
		<tr>
			...
			<!-- <td style="width:65px"><img src="images/logotipo.png"></td> -->
			...
			<td style="background-color:white; width:110px; text-align:center; color:red"><br><br>Ticket No.<br>$numdeSalida</td>
...
<h2 style="text-align:center;">REPORTE DE SALIDA POR VENTA</h2>
...
$idCliente=$respuestaAlmacen[0]["id_cliente"];
...
$fechaSalida=date("d/m/Y h:i:s A", strtotime($respuestaAlmacen[0]["ultmodificacion"]));
...
$entregaen=$respuestaAlmacen[0]["id_tipovta"]==0?"Mostrador":"Domicilio";
...
$bloque3 = <<<EOF
    ...
    <tr>		
		...
		<td style="border: 1px solid #666; width:240px">Usuario: $usuario</td>
	</tr>
	
	<tr>
	   <td style="border: 1px solid #666; width:135px">Ticket No.: $numdeSalida</td>

	   <td style="border: 1px solid #666; width:165px; text-align:left"> 
	    Entrega en: $entregaen
	   </td>

        <td style="border: 1px solid #666; width:240px">Sucursal de Salida: $idAlmacen - $nombreAlmacen</td>
	</tr>

 	<tr>
		<td style="border: 1px solid #666; width:300px">Tipo Mov.: $id_tipomov - $nombre_tipo</td>
        <td style="border: 1px solid #666; width:240px">Fecha y hora de salida: $fechaSalida</td>
	</tr>
...
$cambiode=$pagocon<>0?number_format($pagocon-$granTotal, 2):0;
...
$bloque6 = <<<EOF
	...
	<br/>
	<tr bgcolor="#cccccc">
		<td style="border: 1px solid #666; width:382px; text-align:right">Pagó:</td>
		<td style="border: 1px solid #666; width:54px; text-align:center">$$pagocon</td>
		<td style="border: 1px solid #666; width:44px; text-align:right">Cambio:</td>
		<td style="border: 1px solid #666; width:60px; text-align:center">$$cambiode</td>
    </tr>
