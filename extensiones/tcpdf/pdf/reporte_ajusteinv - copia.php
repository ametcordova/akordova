...
$bloque4 = <<<EOF
 	...
 	<table style="font-size:10px; padding:5px 5px;">
	  ...
	  <tr bgcolor="#cccccc" class="text-center">
		...
		<td style="border: 1px solid #666; width:135px; text-align:center;">Código</td>
...
// ---------------------------------------------------------
$granTotal=$filas=0;
$datos_json=json_decode($datosAjuste,TRUE);
...
$bloque5 = <<<EOF
 	...
 	<table style="font-size:9px; padding:3px 3px;">
      ...
      <tr>
       ...
       <td style="border: 1px solid #666; width:135px; text-align:center">$codigointerno</td>
       <td style="border: 1px solid #666; width:240px; text-align:center">$descripcion</td>
