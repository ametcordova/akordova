...
$printer->text("Modelorama Centenario" . "\n");
$printer->text("Av. Pericles No.401 Col. Centenario" . "\n");
#La fecha también
...
*/
$printer->text("Muchas gracias por su compra\Lo Esperamos!!");



/*Alimentamos el papel 4 veces*/
$printer->feed(4);
