          ...
          foreach ($almacenes as $key => $value) {
            ...
            echo '<tr>
              ...
              <td>
                      ...
                      echo '<button class="btn btn-warning btn-sm btnEditarAlmacen" data-toggle="modal" data-target="#modalEditarAlmacen" idAlmacen="'.$value["id"].'"><i class="fa fa-pencil"></i></button>';
                      }
    ...
    <form role="form" method="POST">
      ...
      <div class="modal-body">
        ...
        <div class="card card-info">
         <div class="card-body">
			<span>Sin espacios ni simbolos, min. 8 max. 10 caracteres</span>
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <span class="input-group-text"><i class="fa fa-building-o"></i></span>
              </div>
              <input type="text" class="form-control input-lg" placeholder="Nombre" name="nuevoAlmacen" title="Sin espacios ni simbolos, min. 8 max. 10 caracteres" maxlength="10" pattern="[A-Za-z0-9_]{8,10}" autofocus onkeyUp="mayuscula(this);" required>
      ...
      <div class="modal-footer colorbackModal">
        ...
        <button type="submit" class="btn btn-success"><i class="fa fa-save"></i> Crear Almacen</button>
...
<script defer src="vistas/js/crear-almacen.js"></script>
<?php
