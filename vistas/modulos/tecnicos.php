  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	 ...
	 <button class="btn btn-danger btn-sm" id="btnregresar" onclick="regresar()" type="button"><i class="fa fa-arrow-circle-left"></i> Regresar</button>          
        ...
        <div class="card-body">
              <table id="TablaTecnicos" class="table table-bordered table-striped dt-responsive activarDatatable" width="100%">
                <thead>
                <tr>
            ...
            echo '<tr>
                    ...
                    echo '<td>
                      ...
                      <div class="btn-group">
                        ...
                        <button class="btn btn-info btn-sm btnVerTecnico" title="Visualizar" data-toggle="modal" data-target="#modalVerTecnico" idTecnico="'.$value["id"].'"><i class="fa fa-eye"></i> </button>

                        <button class="btn btn-warning btn-sm btnEditarTecnico " title="Editar" data-toggle="modal" data-target="#modalEditarTecnico" idTecnico="'.$value["id"].'"><i class="fa fa-pencil"></i></button>';
        ...
        <div class="form-row">
         ...
         <div class="form-row">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-4">
			  <select id="inputState" class="form-control form-control-sm" name="NuevoEstado" id="NuevoEstado" data-toggle="tooltip" title="Estado de Residencia">
          ...
          <div class="form-row">
            <div class="form-group col-md-4">
			  <select id="inputState" class="form-control form-control-sm" name="NacimientoEstado" id="NacimientoEstado" data-toggle="tooltip" title="Estado de nacimiento">
            ...
            <div class="form-group col-md-5">
			  <select id="inputState" class="form-control form-control-sm" name="NuevoAlmacen" id="NuevoAlmacen" data-toggle="tooltip" title="Almacen Asignado">
            ...
            <div class="form-group col-md-3">
			  <select id="inputState" class="form-control form-control-sm" name="NuevoEstatus" id="NuevoEstatus" data-toggle="tooltip" title="Estatus">
