...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
            <div class="card-body">
              <table class="table table-bordered compact table-hover table-striped dt-responsive " id="datatableAI" width="100%">
         ...
         <div class="card-body m-0">
          ...
          <div class="form-row " id="agregarProd">        <!--tmb invisible -->
            ...
            <div class="col-md-1 ">
              ...
              <input type="number" class="form-control form-control-sm text-center  font-weight-bold inputVta" name="cantExist" id="cantExist" value="" step="any" readonly title="cantidad Existente" >
            </div>
