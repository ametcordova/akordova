      ...
      <div class="card">
        <div class="card-header m-1 p-1">
          ...
          <div class="row ">
            ...
            <div class="form-group col-md-2">
                <select multiple="multiple[]" class="form-control form-control-sm familyName" id="familySel" name="familySel" tabindex="2">
            ...
            <div class="col- mr-2 form-check">
              <input class="form-check-input checkbox-inline" type="checkbox" value="1" name="SelFamTodos" id="SelFamTodos" >
...
<!--
            <div class="form-group col-md-2">
                <select class="form-control form-control-sm" id="famInventario" name="famInventario" tabindex="2">
                  <option value=0 selected>Seleccione Familia</option>
                     <?php
                      $item=null;
                      $valor=null;
                      $familiaInv=ControladorFamilias::ctrMostrarFamilias($item, $valor);
...
-->                        
          <?php if(getAccess($acceso, ACCESS_VIEW)){?>             
	          <div class="form-group col-md-1 mr-3">
               <button class="btn btn-success btn-sm" onclick="listarInventario()" title="Ver en Pantalla" ><i class="fa fa-eye"></i>  Mostrar</button>
            </div>
          <?php } ?>
        ...
        <div class="card-body p-2">
	        ...
	        <table id="tablalistado" class="table table-bordered compact striped hover dt-responsive" width="100%">
               <thead class="thead-dark">
                 ...
                 <th style="width:70px;">Resurtir</th>
                 <th style="width:70px;">P. Venta</th>
  ...
  <!-- /.content-wrapper   -->
  <script defer src="vistas/js/reporteinventario.js"></script>
<?php 
ob_end_flush();
?>
