<?php             
   define ('RAZON_SOCIAL', 'Modelorama Centenario');
   define ('DIRECCION', 'Av. Perícles y Catazajá No. 401');
   define ('COLONIA','Fracc. Centenario');
   define ('CIUDAD','Tuxtla Gtz., Chiapas');
